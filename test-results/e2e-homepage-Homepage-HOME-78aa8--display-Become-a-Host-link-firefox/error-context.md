...
Locator: getByRole('link', { name: /become a host/i })
Expected: visible
Timeout: 10000ms
...
Call log:
  ...
  - waiting for getByRole('link', { name: /become a host/i })
