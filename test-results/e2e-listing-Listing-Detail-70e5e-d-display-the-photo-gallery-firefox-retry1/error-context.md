...
- Name: e2e\listing.spec.ts >> Listing Detail Page >> LISTING-004: should display the photo gallery
- Location: tests\e2e\listing.spec.ts:51:7
...
Locator: locator('[data-section-id="HERO_DEFAULT"]').or(locator('img[aria-label]').first())
Expected: visible
Timeout: 10000ms
...
Call log:
  ...
  - waiting for locator('[data-section-id="HERO_DEFAULT"]').or(locator('img[aria-label]').first())
